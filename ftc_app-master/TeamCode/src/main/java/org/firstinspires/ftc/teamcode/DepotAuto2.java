...
@Autonomous(name="Depot2", group="PushBot")
@Disabled
public class DepotAuto2 extends LinearOpMode{
    ...
    public void runOpMode(){
       ...
       // detector.alignPosOffset = 0; // How far from center frame to offset this alignment zone.
        ...
        runtime.reset();
            ...
            robot.phoneServo.setPosition(.47);
            unlatch(6.6);
            strafeLeft(.3,2.0);
            moveBackward(.3, 1.7);
            CheckAllign();
            ...
            strafeRight(0.3, 0.8);
        //    moveForward(0.5, 0.7);
            moveBackward(0.3, 0.35);
            strafeRight(0.3, 2.0);
            markerDown();
// Program the moveBackward method during competition. Maybe for 5 sec for 0.5 speed
